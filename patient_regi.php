	...
	<div class="recipient_reg" style="background-color:#272327;">
		...
		<form enctype="multipart/form-data" method="post" class="text-center">
			 <div class="col-md-12">
			 		...
			 		<label>
						Your Name: <input type="text" name="name" value="" placeholder="Full name" required="required" pattern="[a-zA-Z]{2,15}" title="please enter only character for your name" />
					</label><br><br>
					...
					<label>
				Confirm Password: <input type="password" name="confirm password"  value="" placeholder="confirm password" required>
					</label><br><br><br><br>
